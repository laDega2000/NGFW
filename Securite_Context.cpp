...
bool Securite_Context::execute_strategy(char *src_mac, int src_mac_len, char *packet, int packet_len, Policy& p, tabses& s,tabdomain& tab)
{
    return strategy->execute(src_mac,src_mac_len,packet, packet_len, p,s,tab);
}
